    ...
    if(getData.length > 0){
        for(var i=tab_start; i<tab_end; i++){
            ...
            if(staff){
                ...
                <td>${staff.statsVal}</td>
                <td>${staff.categoryVal}</td>
                <td>${staff.paymentVal}</td>
                <td>${staff.sDateVal}</td>
                <td>${staff.emailVal}</td>
                <td>${staff.phoneVal}</td>
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.priceVal}', '${staff.statsVal}', '${staff.categoryVal}', '${staff.paymentVal}', '${staff.sDateVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.priceVal}', '${staff.statsVal}', '${staff.categoryVal}', '${staff.paymentVal}', '${staff.sDateVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, lname, Price, Stats, Category, Payment, SDate, Email, Phone){
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
    price.value = Price
...
function editInfo(id, pic, fname, lname, Price, Stats, Category, Payment, SDate, Email, Phone){
    isEdit = true
    editId = id
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        const filteredData = originalData.filter((item) => {
            ...
            const stats = item.statsVal.toLowerCase()
            const category = item.categoryVal.toLowerCase()

            return(
                fullName.includes(searchTerm) ||
                stats.includes(searchTerm) ||
